...
Держи списочек (если список пустой, значит в ближайшие 6 дней ни у кого др нет!)
Вот эти людишки (если список пустой, значит в ближайшие 6 дней ни у кого др нет!)
Вот они, эти счастливчики (если список пустой, значит в ближайшие 6 дней ни у кого др нет!)
'''.splitlines()

plugin = Plugin('Дни рождения в группе', usage="др, дни рождения - узнать дни рождения в группе")


# TODO: Отрефакторить эту херню
@plugin.on_command('др', 'дни рождения')
