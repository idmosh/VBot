...
plugin = Plugin("Калькулятор",
                usage=["посчитай, посчитать, сколько будет, сколько [выражение] - посчитать результат с помощью калькулятора",
...
@plugin.on_command('посчитай', 'посчитать', 'посч', 'сколько', 'сколько будет')
